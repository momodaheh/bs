...
import com.bs.pojo.AliPayConfig;
...
//    private OrdersMapper ordersMapper;
    ...
    public void pay(String orderId, HttpServletResponse httpResponse) throws Exception {
        ...
        bizContent.set("total_amount", order.getPrice()); // 订单的总金额
        bizContent.set("subject", good.getGoodsName());   // 支付的名称
        bizContent.set("product_code", "FAST_INSTANT_TRADE_PAY");  // 固定配置
        request.setBizContent(bizContent.toString());
        request.setReturnUrl("http://localhost:8080/payOrder");
