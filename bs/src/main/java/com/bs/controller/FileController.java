...
public class FileController {
    ...
    public ResultEntity upload(@RequestBody MultipartFile file) {
        ...
        return ResultEntity.infor(ResultCode.SUCCESS,http + flag + "-" + fileName);  //  http://localhost:9090/files/1697438073596-avatar.png
    }
...
//
     ...
     */
    @RequestMapping("flag")
    public ResultEntity delFile(@RequestBody String flag) {
